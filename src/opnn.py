"""define outer product neural network model"""
import math
...
class OpnnModel(BaseModel):
    ...
    def _build_graph(self, hparams):
        ...
        with tf.variable_scope("Opnn") as scope:
    ...
    def _build_product_layer(self, hparams):
        ...
        with tf.variable_scope("kernel", initializer=self.initializer) as scope:
            self.k = tf.get_variable(name='product_kernel', shape=[embed_size, num_pairs, embed_size],
                                     dtype=tf.float32)
